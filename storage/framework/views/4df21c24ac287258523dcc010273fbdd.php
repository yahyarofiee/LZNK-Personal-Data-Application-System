...
<div class="dash-wrap">
    ...
    <div class="stat-grid">
        ...
        <div class="stat-card proses">
            ...
            <div class="stat-value"><?php echo e($proses); ?></div>
        ...
        <div class="stat-card lulus">
            ...
            <div class="stat-value"><?php echo e($lulus); ?></div>
        ...
        <div class="stat-card tolak">
            ...
            <div class="stat-value"><?php echo e($tolak); ?></div>
    ...
    <div class="content-grid">
        ...
        <div class="panel">
            <div class="panel-head">
                ...
                <a href="<?php echo e(route('permohonan.index')); ?>" class="panel-head-link">
                    Lihat Semua
            ...
            <table class="dash-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="td-date-main"><?php echo e($item->created_at->format('d/m/Y')); ?> &nbsp; <?php echo e($item->created_at->format('h:i A')); ?></div>
                            <div class="td-date-rel"><?php echo e($item->created_at->diffForHumans()); ?></div>
                        </td>
                        <td class="td-jenis"><?php echo e($item->jenis); ?></td>
                        <td>
        ...
        <div class="panel">
            ...
            <div class="qa-body">
                ...
                <a href="<?php echo e(route('permohonan')); ?>" class="qa-btn-primary">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                    Mohon Data Baru
                </a>

                <a href="<?php echo e(route('permohonan.index')); ?>" class="qa-btn-secondary">
                ...
                <div class="qa-info-row">
                    ...
                    <span class="qa-info-val"><?php echo e($total); ?> permohonan</span>
                </div>
                <div class="qa-info-row">
                    <span class="qa-info-label">Dalam Proses</span>
                    <span class="qa-info-val" style="color:#b45309;"><?php echo e($proses); ?></span>
                </div>
                <div class="qa-info-row">
                    <span class="qa-info-label">Diluluskan</span>
                    <span class="qa-info-val" style="color:#166534;"><?php echo e($lulus); ?></span>
                </div>
                <div class="qa-info-row">
                    <span class="qa-info-label">Ditolak</span>
                    <span class="qa-info-val" style="color:#991b1b;"><?php echo e($tolak); ?></span>
                </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\MohonData-LZNK\resources\views/pemohon/dashboard.blade.php ENDPATH**/ ?>