...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app-timbalan','data' => ['title' => 'Dashboard Timbalan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Dashboard Timbalan']); ?>
...
<div class="dash-wrap">
    ...
    <div class="dash-page-header">
        ...
        <div class="dash-date-badge"><?php echo e(now()->format('d/m/Y')); ?></div>
    </div>

    <div class="stat-grid">

        <a href="<?php echo e(route('timbalan.menunggu.kelulusan.timbalan')); ?>" class="stat-card menunggu">
            <div class="stat-icon menunggu">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
            </div>
            <div class="stat-label">Menunggu Kelulusan</div>
            <div class="stat-value"><?php echo e(\App\Models\Permohonan::where('status','Menunggu Kelulusan Timbalan')->count()); ?></div>
            <div class="stat-sub">Memerlukan tindakan</div>
        </a>

        <a href="<?php echo e(route('timbalan.diluluskan')); ?>" class="stat-card lulus">
            <div class="stat-icon lulus">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
            </div>
            <div class="stat-label">Diluluskan</div>
            <div class="stat-value"><?php echo e(\App\Models\Permohonan::where('status','Diluluskan')->count()); ?></div>
            <div class="stat-sub">Berjaya diluluskan</div>
        </a>

        <a href="<?php echo e(route('timbalan.ditolak')); ?>" class="stat-card tolak">
            <div class="stat-icon tolak">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>
            </div>
            <div class="stat-label">Ditolak</div>
            <div class="stat-value"><?php echo e(\App\Models\Permohonan::where('status','Ditolak')->count()); ?></div>
            <div class="stat-sub">Tidak diluluskan</div>
        </a>

    </div>

    <?php $menungguCount = \App\Models\Permohonan::where('status','Menunggu Kelulusan Timbalan')->count(); ?>
    <div class="panel">
        <div class="panel-head">
            <span class="panel-head-title">Permohonan Menunggu Kelulusan Timbalan</span>
            <span class="panel-count"><?php echo e($menungguCount); ?> menunggu</span>
        </div>
        ...
        <table class="dpo-table">
            ...
            <?php $senarai = \App\Models\Permohonan::where('status','Menunggu Kelulusan Timbalan')->latest()->get(); ?>
            ...
            <tr>
                ...
                <td class="center">
                    <button onclick="openModal(<?php echo e($permohonan->id); ?>)" class="act-btn act-detail">
...
<?php endif; ?><?php /**PATH C:\laragon\www\MohonData-LZNK\resources\views/timbalan/dashboard.blade.php ENDPATH**/ ?>