...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Rekod Permohonan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Rekod Permohonan']); ?>
...
<div class="rekod-wrap">
    ...
    <div class="rekod-page-header">
        ...
        <a href="<?php echo e(route('permohonan')); ?>" class="btn-new">
    ...
    <div class="rekod-panel">
        ...
        <table class="rekod-table">
            ...
            <tbody>
                <?php $__currentLoopData = $permohonan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>

                    <!-- TARIKH -->
                    <td>
                        <div class="td-date-main"><?php echo e($p->created_at->format('d/m/Y')); ?> &nbsp; <?php echo e($p->created_at->format('h:i A')); ?></div>
                        <div class="td-date-rel"><?php echo e($p->created_at->diffForHumans()); ?></div>
                    </td>

                    <!-- JENIS -->
                    <td class="td-jenis"><?php echo e($p->jenis); ?></td>

                    <!-- STATUS -->
                    <td>
                        <?php if($p->status == 'Dalam Proses'): ?>
                            <span class="badge badge-proses">Dalam Proses</span>
                        <?php elseif($p->status == 'Diluluskan'): ?>
                            <span class="badge badge-lulus">Diluluskan</span>
                        <?php elseif($p->status == 'Ditolak'): ?>
                            <span class="badge badge-tolak">Ditolak</span>
                        <?php else: ?>
                            <span class="badge badge-proses"><?php echo e($p->status ?? 'Dalam Proses'); ?></span>
                        <?php endif; ?>
                        ...
                        <div>
                            <button
                                type="button"
                                onclick='openSebabModal(<?php echo json_encode($p->catatan, 15, 512) ?>, <?php echo json_encode($p->catatan_dokumen, 15, 512) ?>)'
                    ...
                    <button
                        onclick="openPemohonModal(<?php echo e($p->id); ?>)"
                        class="btn btn-sm"
                        style="
                            background:#ecfdf5;
                            color:#166534;
                    ...
                    <?php if($p->status == 'Diluluskan'): ?>

                        <button
                            type="button"
                            onclick="openDokumenModal(<?php echo e($p->id); ?>)"
                            class="btn btn-sm"
                            style="
                                background:#eff6ff;
                                color:#1d4ed8;
                    ...
                    <td>
                        <div class="action-group">
                            ...
                            <?php if($p->status !== 'Diluluskan'): ?>
                            <a href="<?php echo e(route('permohonan.edit', $p->id)); ?>" class="act-btn act-update">
                            ...
                            <form action="<?php echo e(route('permohonan.delete', $p->id)); ?>" method="POST" class="delete-form" style="display:inline;">
                                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\MohonData-LZNK\resources\views/pemohon/rekod.blade.php ENDPATH**/ ?>