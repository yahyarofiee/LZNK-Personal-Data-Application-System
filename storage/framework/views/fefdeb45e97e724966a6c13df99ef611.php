...
<head>
    ...
    <title><?php echo e($title ?? 'Dashboard'); ?> — DPO LZNK</title>
...
<div class="dpo-layout">
    ...
    <aside class="dpo-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('dpo.permohonan')); ?>"
               class="nav-link <?php echo e(request()->routeIs('dpo.permohonan') ? 'active' : ''); ?>">
                <div class="nav-link-left">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="<?php echo e(route('dpo.dalam.proses')); ?>"
               class="nav-link <?php echo e(request()->routeIs('dpo.dalam.proses') ? 'active' : ''); ?>">
                <div class="nav-link-left">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="<?php echo e(route('dpo.diluluskan')); ?>"
               class="nav-link <?php echo e(request()->routeIs('dpo.diluluskan') ? 'active' : ''); ?>">
                <div class="nav-link-left">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="<?php echo e(route('dpo.ditolak')); ?>"
               class="nav-link <?php echo e(request()->routeIs('dpo.ditolak') ? 'active' : ''); ?>">
                <div class="nav-link-left">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
...
</html><?php /**PATH C:\laragon\www\MohonData-LZNK\resources\views/components/layouts/app-dpo.blade.php ENDPATH**/ ?>