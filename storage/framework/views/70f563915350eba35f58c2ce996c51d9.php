...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Permohonan Data']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Permohonan Data']); ?>
...
<div class="lznk-page">
    ...
    <div id="formContainer" class="form-shell">
        ...
        <form id="permohonanForm" action="<?php echo e(route('permohonan.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\MohonData-LZNK\resources\views/pemohon/permohonan.blade.php ENDPATH**/ ?>