...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app-dpo','data' => ['title' => 'Semua Permohonan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<div class="page-wrap">
    ...
    <div class="panel">
        <div class="panel-head">
            ...
            <span class="panel-count"><?php echo e(\App\Models\Permohonan::count()); ?> rekod</span>
        </div>
        ...
        <table class="dpo-table">
            ...
            <button
                type="button"
                onclick="openTolakModal(<?php echo e($item->id); ?>)"
            ...
            <button
                ...
                onclick="openDokumenModal(<?php echo e($item->id); ?>)">
                📂 Urus Dokumen
            </button>
...
<?php endif; ?><?php /**PATH C:\laragon\www\MohonData-LZNK\resources\views/dpo/semua-permohonan.blade.php ENDPATH**/ ?>