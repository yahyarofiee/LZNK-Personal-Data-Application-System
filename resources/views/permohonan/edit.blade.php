<x-layouts.app title="Kemaskini Permohonan">
...
<div class="kemaskini-wrap">
    ...
    <div class="alert-tolak">
        ...
        <div>
            ...
            <div class="alert-tolak-msg">{{ $data->catatan ?? 'Tiada sebab diberikan' }}</div>
        </div>
    </div>
    @endif

    <form method="POST" action="{{ route('permohonan.update', $data->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-shell">
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    ...
                    <div class="field-wrap">
                        ...
                        <input type="text" name="telefon" value="{{ $data->telefon }}">
                    </div>

                    <div class="field-wrap">
                        <label>Negeri</label>
                        <input type="text" name="negeri" value="{{ $data->negeri }}">
                    </div>
                    ...
                    <div class="field-wrap">
                        <label>Poskod</label>
                        <input type="text" name="poskod" value="{{ $data->poskod }}">
                    </div>
            ...
            <div class="form-section">
                ...
                <div class="field-wrap">
                    <label>Tujuan</label>
                    <textarea name="tujuan" rows="4">{{ $data->tujuan }}</textarea>
                </div>
            </div>
                ...
                <div class="upload-grid">
                    ...
                    <div class="upload-card">
                        ...
                        <div id="preview_surat" class="file-preview-row">
                            <button type="button" onclick="openPdfModal('{{ $data->surat }}')" class="file-preview-btn">
                        ...
                        <div id="upload_surat" class="{{ $data->surat ? 'hidden' : '' }}">
                    ...
                    <div class="upload-card">
                        ...
                        <div id="preview_ic" class="file-preview-row">
                            <button type="button" onclick="openPdfModal('{{ $data->ic }}')" class="file-preview-btn">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                        ...
                        <div id="upload_ic" class="{{ $data->ic ? 'hidden' : '' }}">
                    ...
                    <div class="upload-card">
                        ...
                        <div id="preview_ssm" class="file-preview-row">
                            <button type="button" onclick="openPdfModal('{{ $data->ssm }}')" class="file-preview-btn">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                                Lihat Sijil SSM
                            </button>
                        ...
                        <div id="upload_ssm" class="{{ $data->ssm ? 'hidden' : '' }}">
                    ...
                    <div class="upload-card">
                        ...
                        <div id="preview_ros" class="file-preview-row">
                            <button type="button" onclick="openPdfModal('{{ $data->ros }}')" class="file-preview-btn">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                                Lihat Sijil ROS
                            </button>
                        ...
                        <div id="upload_ros" class="{{ $data->ros ? 'hidden' : '' }}">
