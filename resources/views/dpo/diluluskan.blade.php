<x-layouts.app-dpo title="Diluluskan">
...
<style>
    ...
    .selesai-wrap svg { width: 13px; height: 13px; color: #16a34a; }
...
<div class="page-wrap">
    ...
    <div class="panel">
        ...
        <table class="dpo-table">
            ...
            @forelse(\App\Models\Permohonan::where('status','Diluluskan')->latest()->get() as $item)
            <tr>
                <td>
