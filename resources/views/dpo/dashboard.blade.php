<x-layouts.app-dpo title="Dashboard">
            ...
            <tr>
                ...
                <td class="center">
                    ...
                    @if($item->status === 'Dalam Proses')
                        ...
                        <button type="button" onclick="openTolakModal({{ $item->id }})" class="act-btn act-tolak">
