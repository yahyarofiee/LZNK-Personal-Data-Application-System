...
<head>
    <meta charset="UTF-8">
    <title>{{ $title ?? 'Dashboard' }} — Timbalan LZNK</title>
...
<div class="dpo-layout">
    ...
    <aside class="dpo-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('timbalan.permohonan') }}"
               class="nav-link {{ request()->routeIs('timbalan.permohonan') ? 'active' : '' }}">
                <div class="nav-link-left">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ route('timbalan.menunggu.kelulusan.timbalan') }}"
               class="nav-link {{ request()->routeIs('timbalan.menunggu.kelulusan.timbalan') ? 'active' : '' }}">
                <div class="nav-link-left">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ route('timbalan.diluluskan') }}"
               class="nav-link {{ request()->routeIs('timbalan.diluluskan') ? 'active' : '' }}">
                <div class="nav-link-left">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ route('timbalan.ditolak') }}"
               class="nav-link {{ request()->routeIs('timbalan.ditolak') ? 'active' : '' }}">
                <div class="nav-link-left">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
