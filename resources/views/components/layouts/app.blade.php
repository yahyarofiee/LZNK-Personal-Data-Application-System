...
<head>
    ...
    <link rel="icon" type="image/jpg" sizes="32x32" href="{{ asset('images/lznk.png') }}">
    ...
    <aside class="lznk-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('permohonan') }}"
               class="nav-link {{ request()->routeIs('permohonan') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ route('permohonan.index') }}"
               class="nav-link {{ request()->routeIs('permohonan.index') || request()->routeIs('permohonan.edit') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/>
                    <polyline points="14 2 14 8 20 8"/>
                ...
                <div style="position: relative;">
                    ...
                    <div class="user-dropdown" id="userDropdown">
                        ...
                        <div class="dropdown-user-info">
                            ...
                            <div class="dropdown-user-info-email">{{ auth()->user()->email }}</div>
                        </div>
