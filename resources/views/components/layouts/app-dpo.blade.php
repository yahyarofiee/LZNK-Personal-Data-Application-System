@props(['title' => 'Dashboard', 'pending' => 0])
...
<head>
    ...
    <title>{{ $title ?? 'Dashboard' }} — DPO LZNK</title>

    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('images/lznk.png') }}">
    <link rel="shortcut icon" href="{{ asset('images/lznk.png') }}">
...
<div class="dpo-layout">
    ...
    <aside class="dpo-sidebar">
        ...
        <div class="sidebar-logo">
            <img src="{{ asset('images/lznk-logo.png') }}" alt="LZNK">
            <div class="sidebar-logo-divider"></div>
            <div class="sidebar-logo-text">
                <div class="sidebar-logo-name">LZNK</div>
                <div class="sidebar-logo-role">DPO Panel</div>
            </div>
        </div>
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('dpo.permohonan') }}"
               class="nav-link {{ request()->routeIs('dpo.permohonan') ? 'active' : '' }}">
                <div class="nav-link-left">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ route('dpo.dalam.proses') }}"
               class="nav-link {{ request()->routeIs('dpo.dalam.proses') ? 'active' : '' }}">
                <div class="nav-link-left">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ route('dpo.diluluskan') }}"
               class="nav-link {{ request()->routeIs('dpo.diluluskan') ? 'active' : '' }}">
                <div class="nav-link-left">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ route('dpo.ditolak') }}"
               class="nav-link {{ request()->routeIs('dpo.ditolak') ? 'active' : '' }}">
                <div class="nav-link-left">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="sidebar-footer">
            <div class="sidebar-user">
                <img src="https://i.pravatar.cc/60?u={{ auth()->id() }}" alt="Avatar" class="sidebar-avatar">
                <div class="sidebar-user-info">
                    <div class="sidebar-user-name">{{ auth()->user()->name }}</div>
                    <div class="sidebar-user-role">Data Protection Officer</div>
                </div>
            </div>
        </div>
    ...
    <div class="dpo-main">
        ...
        <header class="dpo-topbar">
            ...
            <div class="topbar-left">
                <span class="topbar-dpo-chip">DPO Panel</span>
            ...
            <div class="topbar-right">
                ...
                <div style="position: relative;">
                    <button class="topbar-user-btn" id="userMenuBtn" onclick="toggleUserMenu()">
                        <img src="https://i.pravatar.cc/60?u={{ auth()->id() }}" alt="Avatar" class="topbar-user-avatar">
                        <div class="topbar-user-info">
                            <span class="topbar-user-name">{{ auth()->user()->name }}</span>
                            <span class="topbar-user-role">DPO</span>
                        </div>
                    ...
                    <div class="user-dropdown" id="userDropdown">
                        ...
                        <div class="dropdown-user-info">
                            <div class="dropdown-user-info-name">{{ auth()->user()->name }}</div>
                            <div class="dropdown-user-info-sub">Data Protection Officer</div>
                        </div>
